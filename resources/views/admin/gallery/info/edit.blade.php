              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="col-md-8 mx-auto">
                    <form action="{{route('info.update', $siteinfo->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                      ...
                      <div class="form-group">
                        ...
                        <select name="gallery_id" class="form-control @error('gallery_id') is-invalid @enderror">
                          ...
                          @foreach($galleries as $gallery)
                            <option {{ $gallery->id == $siteinfo->gallery->id ? 'selected' : ''}} value="{{$gallery->id}}">{{$gallery->title}}</option>
                          @endforeach
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="description" rows="10" name="description" class="form-control @error('description') is-invalid @enderror">{{$siteinfo->description}}</textarea>
